...
# -----------------------------------------------------------------------------
_C.MODEL.PRIORS = CN()
_C.MODEL.PRIORS.FEATURE_MAPS = [38, 19, 10, 5]  # [38, 19, 10, 5, 3, 1]
_C.MODEL.PRIORS.STRIDES = [8, 16, 32, 64]  # [8, 16, 32, 64, 100, 300]
_C.MODEL.PRIORS.MIN_SIZES = [32, 64, 128, 256]  # [30, 60, 111, 162, 213, 264]
_C.MODEL.PRIORS.MAX_SIZES = [60, 111, 162, 213, 264, 315]  # do not use max_size in S3FD anchors
_C.MODEL.PRIORS.ASPECT_RATIOS = [[2], [2], [2], [2]]  # [[2], [2, 3], [2, 3], [2, 3], [2], [2]]
# When has 1 aspect ratio, every location has 4 boxes, 2 ratio 6 boxes.
# #boxes = 2 + #ratio * 2
_C.MODEL.PRIORS.BOXES_PER_LOCATION = [3, 3, 3, 3]  # [4, 6, 6, 6, 4, 4]  # number of boxes per feature map location
